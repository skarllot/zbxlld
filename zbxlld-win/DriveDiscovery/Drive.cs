...
public partial class Drive
{
    ...
    [LoggerMessage(
        LogLevel.Critical,
        "Not enough memory to get all volumes information")]
    private partial void LogOutOfMemory(Exception exception);

    [LoggerMessage(
        LogLevel.Error,
        "Unexpected error trying to get all volumes information")]
    private partial void LogUnexpectedError(Exception exception);

    [LoggerMessage(LogLevel.Information, "Failed to use WMI falling back to framework implementation")]
    private partial void LogWmiNotAvailable();
}
